...
public class MysqlGenerator {
    ...
    public static final String OUT_PUT_PATH = "/07-exception/src/main/java";
    public static final String TEMPLATES_MAPPER_XML_PATH = "/templates/mapper.xml.ftl";
    public static final String XML_PATH = "/07-exception/src/main/resources/mapper/";
    public static final String XML_POSTFIX = "Mapper";

    public static final String AUTHOR = "刘水镜";
    public static final String PARENT_PACKAGE = "com.shuijing.boot.exception";
