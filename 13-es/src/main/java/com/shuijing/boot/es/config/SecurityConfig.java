package com.shuijing.boot.es.config;

import com.shuijing.boot.es.manager.security.CustomerAccessDeniedHandler;
import com.shuijing.boot.es.manager.security.CustomerAuthenticationEntryPoint;
import com.shuijing.boot.es.manager.security.CustomerAuthenticationFailureHandler;
import com.shuijing.boot.es.manager.security.CustomerAuthenticationSuccessHandler;
